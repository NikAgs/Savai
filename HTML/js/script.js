...
if ($('.mailchimp').length>0) {
    ...
    $('.mailchimp').ajaxChimp({
        ...
        url: "https://savai.us20.list-manage.com/subscribe/post?u=5c4ce45b8717d78b8e252fd56&amp;id=83502ba094" //Replace this with your own mailchimp post URL. Don't remove the "". Just paste the url inside "".
    });
}
...
$(document).on('submit', '#contactForm', function (e) {
    ...
    var dataString = 'name=' + name + '&email=' + email + '&message=' + message + '&phone=' + phone + '&business=' + business;
